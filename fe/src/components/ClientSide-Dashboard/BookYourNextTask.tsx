      ...
      <div className="h-[451px] bg-white py-[80px]">
        <div className="flex flex-col  ">
          ...
          <div className="flex justify-center mt-2 items-center rounded   ">
            ...
            <Button
              type="submit"
              className="bg-blue-300 rounded-r-full h-[42px] w-[40 px]"
            >
          ...
          <div className="flex flex-wrap mt-[48px]">
            {categories.map((category, index) => (
              <button
                key={index}
                className="border hover:bg-[#d7e7f3] border-gray-300 rounded-full py-2 px-4 m-2 text-gray-700"
              >
                {category}
              </button>
            ))}
